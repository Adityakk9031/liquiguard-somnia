      ...
      <div>
        ...
        <div className="flex flex-col gap-1.5 mb-2">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-pink-950/80 border border-pink-500/30 shrink-0">
              <Flame className="w-4 h-4 text-pink-400" />
            </div>
            <div className="min-w-0">
              <h3 className="text-sm font-bold text-white tracking-tight leading-snug whitespace-nowrap">Market Crash Simulator</h3>
